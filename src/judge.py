...
from src.models import JudgeScore, CompletenessScore
...
class JudgeAgent:
    ...
    def score_completeness(self, golden_answer: str, rag_answer: str) -> CompletenessScore:
        ...
        result = self._completeness_agent.run_sync(prompt)
        return result.output
